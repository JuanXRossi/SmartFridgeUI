...
const styles = {
  ...
  title: "text-2xl font-bold text-amber-600 tracking-tight leading-tight",
  ...
  createBtn: [
    ...
    "hover:bg-amber-600 hover:shadow-[0_4px_16px_rgba(245,158,11,0.35)]",
...
interface UrgenciesHeaderProps {
  count: number;
  onCreate: () => void;
}

export default function UrgenciesHeader({ count, onCreate }: UrgenciesHeaderProps) {
  return (
    <div className={styles.wrapper}>
      <div className={styles.titlesBlock}>
        <span className={styles.eyebrow}>Administración</span>
        <h1 className={styles.title}>Urgencias de Reposición</h1>
        <p className={styles.subtitle}>
          {count} {count === 1 ? "urgencia registrada" : "urgencias registradas"}
        </p>
      </div>
