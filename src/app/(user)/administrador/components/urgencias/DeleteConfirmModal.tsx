...
const styles = {
  ...
  urgencyName: "font-semibold text-[#334E5E]",
    ...
    <div className={styles.overlay} onClick={onClose}>
      ...
      >
        <div className={styles.body}>
          ...
          <p className={styles.title}>¿Eliminar urgencia?</p>
          <p className={styles.description}>
            Estás por eliminar{" "}
            <span className={styles.urgencyName}>{urgency.name}</span>. Esta
